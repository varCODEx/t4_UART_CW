Єдине, чим відрізняється код курсача від коду лаби про UART - ваші значення тактової частоти мікроконтролера та швидкості передачі даних:
```
fCK = 8000000
BAUD = 4800
```  
та налаштування регістру UCSRC (пояснення [тута](texts/uartsettings.md)) :  
```
